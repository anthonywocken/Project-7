...
/**
 * Class Panel displays a grid of MashUpPlayer objects
 * 
...
public class MashUpPanel extends JPanel {
    ...
    public MashUpPanel(MashUpModel model) {
    ...
    public void paintComponent(Graphics g) {
        ...
        g.setFont(myFont);
        Iterator<MashUpPlayer> i = myModel.iterator();          
        while    (i.hasNext()) {
            MashUpPlayer next = i.next();
